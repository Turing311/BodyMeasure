...
from CenterHMR.utils import JointMapper,smpl_to_openpose
from CenterHMR.utils.util import BHWC_to_BCHW, copy_state_dict
from CenterHMR.utils.rot_6D import rot6D_to_angular
from CenterHMR.utils.projection import batch_orth_proj
...
class Base(object):
    ...
    def _calc_smplx_params(self, param):
        ...
        pj3d = batch_orth_proj(j3d_op25, params_dict['cam'], mode='2d')
