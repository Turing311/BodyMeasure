...
project_dir = os.path.abspath(__file__).replace('/config.py','')
root_dir = project_dir.replace(project_dir.split('/')[-1],'')
model_dir = os.path.join(project_dir,'../../HBMC_models/models')
trained_model_dir = os.path.join(project_dir,'../../HBMC_models/models/trained_models')
...
parser.add_argument('--configs_yml',type = str,default = 'CenterHMR/configs/basic_test.yml',help = 'setting for training')
