...
#        self.config = config
        ...
        self.load_path = '../HBMC_models/models/model.ckpt-667589'#config.load_path
...
#            ipdb.set_trace()
        ...
        self.smpl_model_path = '../HBMC_models/models/neutral_smpl_with_cocoplus_reg.pkl'#config.smpl_model_path
